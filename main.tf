...
resource "google_project" "shinsekai-salesforce-dev" {
  name       = "SalesForce-Dev"
  project_id = "shinsekai-salesforce-dev"
...
# resource "google_project" "shinsekai-salesforce-prod" {
#   name       = "SalesForce-Prod"
#   project_id = "shinsekai-salesforce-prod"
